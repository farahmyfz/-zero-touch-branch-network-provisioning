...
<div class="bg-slate-900 text-slate-200 font-sans antialiased overflow-x-hidden min-h-screen">
    ...
    <nav class="flex items-center justify-between px-8 py-6 border-b border-slate-800">
        ...
        <!-- PERUBAHAN 1: Launch Console button diubah menjadi tag <a> menuju /login -->
        <a href="/login" class="bg-blue-600 hover:bg-blue-500 text-white px-5 py-2 rounded-lg text-sm font-semibold transition shadow-lg shadow-blue-500/30">
            Launch Console
        </a>
    </nav>
    ...
    <header class="container mx-auto px-6 pt-20 pb-10 text-center relative">
        ...
        <div class="flex justify-center space-x-4 mb-16">
            <!-- PERUBAHAN 2: Get Started button diubah menjadi tag <a> menuju /login -->
            <a href="/login" class="bg-white text-slate-900 px-8 py-3 rounded-md font-bold hover:bg-slate-200 transition shadow-lg shadow-white/10 inline-block text-center">
                Get Started
            </a>
